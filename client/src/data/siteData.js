export const navLinks = [
  ...
  {
    label: 'Careers',
    href: 'https://career.skumarinfracons.com/',
    hasDropdown: true,
    dropdownLayout: 'simple',
    dropdownItems: [
      'Visit career portal',
...
export const testimonialsData = [
  {
    name: 'Rajesh Mehta',
    role: '',
    text: 'S Kumar Infracons handled our industrial project with good coordination from planning through execution. The team kept us informed about the progress and was responsive whenever issues came up on site.',
    image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
  {
    name: 'Kavita Singh',
    role: '',
    text: 'We appreciated the way the team managed the different stages of our project. Their engineers were available when required, and the work was completed with consistent attention to quality and site requirements.',
    image: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
  {
    name: 'Amit Joshi',
    role: '',
    text: 'The project required careful planning and coordination at multiple stages. S Kumar Infracons maintained proper communication with the concerned teams and delivered the work in accordance with the required specifications.',
    image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
  {
    name: 'Deepika Nair',
    role: '',
    text: 'What stood out for us was the team’s willingness to listen and make adjustments during the construction process. The site team was approachable, and we were kept updated as the work progressed.',
    image: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
  {
    name: 'Vikram Reddy',
    role: '',
    text: 'From the initial discussions to the final handover, the team maintained clear communication about the project. Their approach to coordination, documentation, and execution made the overall process much easier for us.',
    image: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
  {
    name: 'Sunita Verma',
    role: '',
    text: 'I have worked with the S Kumar Infracons team on projects where accurate execution was important. The site team understood the drawings well and worked closely with us whenever clarification was needed during execution.',
    image: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100&h=100&fit=crop&crop=face',
    rating: 5,
  },
];
