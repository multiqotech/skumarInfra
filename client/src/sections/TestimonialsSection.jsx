...
export default function TestimonialsSection() {
  ...
  return (
    <section className="bg-[#FFFDF9] py-14 lg:py-24" id="testimonials">
      <div className="container-custom">
        ...
        <div className="flex items-end justify-between mb-16">
          <AnimateOnScroll>
            ...
            <h2
              className="text-[#0C0C0C] text-2xl md:text-3xl lg:text-4xl font-bold"
          ...
          <AnimateOnScroll delay={0.2}>
            <a
              href="#"
              className="hidden md:inline-flex items-center gap-2 text-[12px] font-semibold uppercase tracking-[0.15em] text-[#0C0C0C] hover:text-[#FFB800] transition-colors border-2 border-[#0C0C0C] rounded-lg hover:border-[#FFB800] px-6 py-3"
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t, index) => (
            <AnimateOnScroll key={index} delay={index * 0.08}>
              <div className="bg-white rounded-2xl p-8 border border-[#EAEAEA] hover:border-[#FFB800]/30 shadow-[0_4px_20px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(255,184,0,0.1)] transition-all duration-500 h-full flex flex-col">
                {/* Stars */}
                ...
                {/* Text */}
                <p className="text-[#555] text-[14px] leading-relaxed mb-8 italic flex-1">
                  &ldquo;{t.text}&rdquo;
                </p>
                ...
                <div className="flex items-center gap-4 mt-auto">
                  ...
                  <div>
                    <h4
                      className="text-[#0C0C0C] text-[15px] font-bold"
                      
                    >
                      {t.name}
                    </h4>
                    <p className="text-[#888] text-[12px] mt-0.5">{t.role}</p>
                  </div>
                </div>
              </div>
            </AnimateOnScroll>
