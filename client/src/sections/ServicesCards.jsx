...
export default function ServicesCards() {
  return (
    <section className="bg-[#FFFDF9] pb-14 lg:pb-24 pt-4" id="services">
      <div className="container-custom">
        ...
        <AnimateOnScroll className="text-center mb-16">
          ...
          <h2
            className="text-[#0C0C0C] text-2xl md:text-3xl lg:text-4xl font-bold max-w-2xl mx-auto leading-tight"
            ...
            <AnimateOnScroll key={index} delay={index * 0.15}>
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-2xl transition-all duration-500 h-full flex flex-col ${
                  service.featured
                    ? 'bg-[#0C0C0C] text-white shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-10'
                    : 'bg-[#FDFCF8] text-[#0C0C0C] border border-[#EAEAEA] hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] hover:border-[#FFB800]/30'
                }`}
              >
                {/* Image */}
                ...
                <div className="p-7">
                  ...
                  <p
                    className={`text-sm leading-relaxed mb-5 ${
                      service.featured ? 'text-white/60' : 'text-[#666]'
                    }`}
                  >
                    {service.description}
                  </p>
