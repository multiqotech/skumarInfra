...
export default function VerticalsSection() {
  return (
    <section className="bg-[#0C0C0C] py-14 lg:py-20" id="verticals">
      <div className="container-custom">
        ...
        <AnimateOnScroll className="text-center mb-12">
          ...
          <h2
            className="text-white text-2xl md:text-3xl lg:text-4xl font-bold max-w-2xl mx-auto mb-3 leading-tight"
            
          >
            Industries We <span className="text-[#FFB800]">Serve</span>
          </h2>
          <p className="text-white/45 text-[14px] max-w-xl mx-auto">
          ...
          {verticalsData.map((vertical, index) => {
            ...
            return (
              <AnimateOnScroll key={index} delay={index * 0.07}>
                <div className="group bg-[#161616] border border-[#2A2A2A] rounded-2xl p-6 hover:border-[#FFB800]/30 hover:bg-[#1C1C1C] transition-all duration-500 cursor-pointer h-full">
                  {/* Icon */}
                  ...
                  <h3
                    className="text-white text-[15px] font-bold mb-2 group-hover:text-[#FFB800] transition-colors duration-300"
