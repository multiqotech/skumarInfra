    ...
    <section className="relative py-14 lg:py-20 overflow-hidden">
      ...
      <div className="relative container-custom">
        ...
        <AnimateOnScroll className="text-center mb-12">
          ...
          <h2
            className="text-white text-2xl md:text-3xl lg:text-4xl font-bold max-w-2xl mx-auto leading-tight drop-shadow-lg"
        ...
        <div className="flex flex-col gap-8">
          {engineeringSolutions.map((item, index) => (
            <AnimateOnScroll key={index} delay={index * 0.12}>
              <div
                className={`group grid md:grid-cols-2 gap-0 bg-[#161616]/20 backdrop-blur-md border-2 border-white/10 rounded-3xl overflow-hidden hover:border-[#FFB800]/40 hover:shadow-[0_0_30px_rgba(255,184,0,0.2)] hover:bg-[#161616]/40 transition-all duration-500 ${
              ...
              >
                ...
                <div className={`p-8 lg:p-10 flex flex-col justify-center ${index % 2 === 1 ? 'md:[direction:ltr]' : ''}`}>
                  ...
                  <h3
                    className="text-white text-xl lg:text-2xl font-bold mb-3"
                ...
                <div className={`relative h-56 md:h-auto min-h-[260px] ${index % 2 === 1 ? 'md:[direction:ltr]' : ''}`}>
                  ...
                  />
                  <div className="absolute inset-0 bg-[#0C0C0C]/20 group-hover:bg-transparent transition-all duration-500" />
                </div>
              </div>
            </AnimateOnScroll>
          ))}
