...
const projectsData = [
  ...
  { title: "Earthwork in Embankment on NH 69, Nagpur-Saoner-Betul", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image1.jpg", description: "Project Cost: Rs 16.39 Cr", timeToBuild: "2013-2016", engineers: "Backbone Enterprises Ltd", location: "Maharashtra" },
  { title: "Material Transport for Road Construction on NH 69A", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image2.jpg", description: "Project Cost: Rs 4.96 Cr", timeToBuild: "2013-2015", engineers: "Sadhbhav Engineering Ltd", location: "Multai-Chindwada-Seoni" },
  { title: "Embankment and Subgrade Work at Palsana", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image3.jpg", description: "Project Cost: Rs 2.87 Cr", timeToBuild: "2014-2015", engineers: "Indian Builders & Contractors Pvt Ltd", location: "Surat, Gujarat" },
  { title: "Embankment & Aggregate Transport for NH 8D Jetpur-Somnath", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image4.jpg", description: "Project Cost: Rs 14.02 Cr", timeToBuild: "2014-2016", engineers: "Backbone Enterprises Ltd", location: "Gujarat" },
  { title: "Road Work on SH Road Boriguma-Ranigunda", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image5.jpg", description: "Project Cost: Rs 4.58 Cr", timeToBuild: "2015-2016", engineers: "Backbone Enterprises Ltd", location: "Odisha" },
  { title: "NH 201, Nabrangpur-Kokasara", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image6.jpg", description: "Project Cost: Rs 14.38 Cr", timeToBuild: "2016-2018", engineers: "Iron Triangle Ltd", location: "Odisha" },
  { title: "Road and Structure Work - NH 5, Jharpokhariya-Baripada-Baleshwar", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image7.jpg", description: "Project Cost: Rs 26.80 Cr", timeToBuild: "2018-2021", engineers: "Iron Triangle Ltd", location: "Odisha" },
  { title: "Structures Contract - NH-148N, Delhi-Vadodara Expressway", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image8.jpg", description: "Project Cost: Rs 16.78 Cr", timeToBuild: "2021-2022", engineers: "MKC Infra Ltd", location: "Delhi-Vadodara Expressway" },
  { title: "Structure Work on Expressway - NH 751, Ahmedabad-Dholera", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image9.jpg", description: "Project Cost: Rs 34.89 Cr", timeToBuild: "2022-2024", engineers: "GHV (India) Pvt Ltd", location: "Ahmedabad-Dholera" },
  { title: "Road Project - Badnawar-Ratlam to Dhamana Kachi", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image10.jpg", description: "Project Cost: Rs 3.99 Cr", timeToBuild: "2023-2024", engineers: "MP PWD Dhar", location: "MP" },
  // Transportation Infrastructure - Ongoing
  { title: "Road Project - Beganda to Kacchibaroda", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image11.jpg", description: "Project Cost: Rs 14.56 Cr (Ongoing)", timeToBuild: "Awarded 2023", engineers: "MP PWD Dhar", location: "MP" },
  { title: "Rural Road Development - Neemakhedi, Budni", category: "transportation-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image12.jpg", description: "Project Cost: Rs 24.38 Cr (Ongoing)", timeToBuild: "Awarded 2023", engineers: "MP PWD Nasrullaganj", location: "MP" },
  { title: "Eight-lane access-controlled Expressway PKG-VIII Gujarat, KM 180 to 190", category: "transportation-infrastructure", projectType: "Awarded", image: "/assets/doc-images/image13.jpg", description: "Project Cost: Rs 308.00 Cr (Ongoing)", timeToBuild: "Awarded 2025", engineers: "Roadways Solution India Infra Ltd", location: "Vadodara Mumbai Expressway" },
  { title: "Eight-lane access-controlled Expressway PKG-VIII Gujarat, KM 175 to 180", category: "transportation-infrastructure", projectType: "Awarded", image: "/assets/doc-images/image14.jpg", description: "Project Cost: Rs 234.00 Cr (Ongoing)", timeToBuild: "Awarded 2025", engineers: "Roadways Solution India Infra Ltd", location: "Vadodara Mumbai Expressway" },

  // Bridges
  { title: "Box Culverts and Bridges on Bharuch-Dahej Road", category: "bridges", projectType: "Ongoing", image: "/assets/doc-images/image15.jpg", description: "Project Cost: Rs 8.23 Cr", timeToBuild: "2012-2014", engineers: "Welspun Project Ltd", location: "Gujarat" },
  { title: "Submersible Bridge Work - Ratlam District", category: "bridges", projectType: "Ongoing", image: "/assets/doc-images/image16.jpg", description: "Project Cost: Rs 10.88 Cr (Ongoing)", timeToBuild: "Awarded 2024", engineers: "MP PWD Ujjain", location: "Ratlam District, MP" },

  // Housing
  { title: "Group Housing Project - 42 Duplex Houses", category: "housing", projectType: "Ongoing", image: "/assets/doc-images/image17.jpg", description: "Project Cost: Rs 10.08 Cr", timeToBuild: "2011-2013", engineers: "Own Project", location: "Diamond Park, Bhopal (MP)" },

  // Ports
  { title: "Embankment Construction at Kandla Port Jetty No. 13", category: "ports", projectType: "Ongoing", image: "/assets/doc-images/image18.jpg", description: "Project Cost: Rs 7.32 Cr", timeToBuild: "2014-2016", engineers: "Kandla Port", location: "Gujarat" },

  // Water Infrastructure
  { title: "Excavation for Pipelines at Falna, Pali (RAJ) - Salaya-Mathura Pipeline", category: "water-infrastructure", projectType: "Ongoing", image: "/assets/doc-images/image19.jpg", description: "Project Cost: Rs 2.60 Cr", timeToBuild: "2014-2015", engineers: "Raviraj Infra / L&T", location: "Falna, Pali (RAJ)" },
];
